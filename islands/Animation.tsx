...
export default function Animation() { 
    ...
    return (
        ...
        <div id="animation"  className={`flex opacity-0 justify-center mt-[30px] lg:mt-[5px] ${
        ...
        <div id="animation"  className={`flex opacity-0 justify-center lg:justify-left ${
        ...
        <div id="animation"  className={`flex opacity-0 justify-center ${
        ...
        <div id="animation"  className={`flex opacity-0 justify-center lg:justify-right ${
        ...
        <div id="animation"  className={`flex opacity-0 justify-center align-baseline ${
        ...
        <div id="animation"  className={`flex opacity-0 justify-center mt-[40px] lg:items-end ${
