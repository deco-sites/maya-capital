...
export default function MenuButtonSideToSide(props: headerProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        <svg width="46" height="17" className="fill-current xl:w-[46px] w-[32px]">
      ...
      >
          ...
          {isOpen
            ? (
              <div className={`w-full h-full flex`}>
                <div className={`w-full xl:w-[39%] xl:p-[35px] px-[24px] py-[35px] h-full flex flex-col`}>
                  <Image
                    src={image || ""}
                    width={80}
                    height={34}
                    alt={""}
                  />
                  <div className={`w-full border-b-1 xl:my-[60px] my-[30px]`}></div>
                  {linkList?.map((link, index) => {
                    ...
                    <div className={`flex flex-row w-fit gap-[25px] absolute top-auto bottom-0 left-0 right-0 mx-[35px] mb-[35px]`}>
                      <a href="https://www.linkedin.com/company/mayacapital/" target="_blank" className={``}>
                        <img src="/linkedin.png" width={20} height={20} alt=""/>
                      </a>
                      <a href="https://www.facebook.com/mayacapital" target="_blank">
                ...
                <div className={`hidden xl:flex w-[62%] xl:opacity-100 justify-center items-center bg-no-repeat bg-cover bg-center h-full`}
                onClick={() => setIsOpen(!isOpen)}
                style={`
                ...
                `}>
                    <svg width="100" height="42" className={`fill-white xl:block hidden`}>
        ...
        <div className={`xl:hidden h-full bg-white w-[30%] opacity-50`} onClick={() => setIsOpen(!isOpen)}>
        </div>
      </div>
      </div>
    </div>
